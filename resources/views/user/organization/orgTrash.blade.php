...
<div class="wrapper">
    <div class="container-fluid">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6 text-right">
                <a href="{{ route('organization.index') }}"><button class="btn btn-primary">View Organization</button></a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Organization Trashed List</h4>
                </div>
            </div>
        </div>
    ...
    @endif
        ...
        <!-- Recent Organization Section section  -->
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <h4 class="mt-0 m-b-15 header-title">Trashed Organization</h4>
                                ...
                                <tbody>
                                    @foreach ($organizations as $index=>$organization)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('organization.restore',[$organization->organization_id]) }}"
                                                    onclick="return confirm('Are you sure you want to restore this Organization?');"
