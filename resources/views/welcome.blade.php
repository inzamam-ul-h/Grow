            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                @auth
                    ...
                    @if ($userType == 'admin')
                        ...
                        <nav>
                            <a href="{{ route('admin.home') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Admin Home</a>
                            <!-- Add more admin-specific links here -->
                        </nav>
                    @elseif ($userType == 'employee')
                        <!-- Employee Navigation Bar -->
                        <nav>
                            <a href="{{ route('employee.home') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Employee Home</a>
