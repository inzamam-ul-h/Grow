                                            ...
                                            @foreach ($courses as $course)
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <form class="assign-form" action="{{ route('orgCourse.store',['id'=>$user_id]) }}" method="POST">
                                                            @csrf
                ...
                <div class="card" style="transition: transform 0.3s; border: none; border-radius: 10px;">
                    ...
                    <div class="card-body" style="padding: 20px;">
                        ...
                        @if (strlen($course->course_description) > 20)
                            <p class="card-text">
                                {{ substr($course->course_description, 0, 20) }}
                                <span id="course-description-more-{{ $course->course_id }}"
                                    style="display: none;">
                                    {{ substr($course->course_description, 20) }}
                                </span>
                                <a href="#" onclick="showMoreDescription({{ $course->course_id }}); return false;">
                                    See More
                                </a>
                            </p>
                        @else
                        ...
                        <div class="icon" style="display: flex; align-items: center; margin-top: 10px;">
                            @if ($course->category_icon)
                                <img src="{{ asset('storage/' . $course->category_icon) }}" alt="Icon"
                                    style="width: 24px; height: 24px; margin-right: 10px;">
                                <div>
                        ...
                        <div style="display: flex; justify-content: space-between; margin-top: 20px;">
                            @if(auth()->user()->usertype == 'admin')
                                ...
                                <button class="btn toggle-status {{ $course->status == '0' ? 'btn-danger' : 'btn-primary' }} btn-sm btn-block"
