        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Add New Chapters</h4>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="chapter_name" name="chapter_name" placeholder="Enter chapter name" value="{{ old('chapter_name') }}" >
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="chapter_description" name="chapter_description" rows="3" placeholder="Enter chapter description" >{{ old('chapter_description') }}</textarea>
