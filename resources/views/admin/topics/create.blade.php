                ...
                <div class="page-title-box">
                    <div class="btn-group pull-right">
                        <ol class="breadcrumb hide-phone p-0 m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('chapter.index',['id'=>$chapter->id]) }}">Chapters</a></li>
                        </ol>
                    </div>
                    <h4 class="page-title">Add New Topics</h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <a href="{{ route('chapter.index',['id'=>$chapter->id]) }}" class="btn btn-secondary">Back</a>
                                </div>
                            </div>
                        </div>

                        <div class="card-body">
                            <form action="{{ route('topic.store', ['id' => $chapter->id]) }}" method="POST" enctype="multipart/form-data" id="topicForm">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="topic_name" name="topic_name" placeholder="Enter topic name" value="{{ old('topic_name') }}" >
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="topic_description" name="topic_description" rows="3" placeholder="Enter topic description" >{{ old('topic_description') }}</textarea>
