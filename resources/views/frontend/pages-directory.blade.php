...
<!-- Mirrored from themesdesign.in/upcube/layouts/horizontal/pages-directory.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Mar 2018 13:18:20 GMT -->
<head>
        <meta charset="utf-8" />
                    ...
                    <div class="col-lg-4">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <div class="media">
                                    <img class="d-flex mr-3 rounded-circle img-thumbnail thumb-lg" src="assets/images/users/avatar-4.jpg" alt="Generic placeholder image">
                                    <div class="media-body">
                    ...
                    <div class="col-lg-4">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <div class="media">
                                    <img class="d-flex mr-3 rounded-circle img-thumbnail thumb-lg" src="assets/images/users/avatar-5.jpg" alt="Generic placeholder image">
                                    <div class="media-body">
                    ...
                    <div class="col-lg-4">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <div class="media">
                                    <img class="d-flex mr-3 rounded-circle img-thumbnail thumb-lg" src="assets/images/users/avatar-6.jpg" alt="Generic placeholder image">
                                    <div class="media-body">
                    ...
                    <div class="col-lg-4">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <div class="media">
                                    <img class="d-flex mr-3 rounded-circle img-thumbnail thumb-lg" src="assets/images/users/avatar-1.jpg" alt="Generic placeholder image">
                                    <div class="media-body">
