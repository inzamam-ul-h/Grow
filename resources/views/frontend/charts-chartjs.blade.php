...
<!-- Mirrored from themesdesign.in/upcube/layouts/horizontal/charts-chartjs.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Mar 2018 13:17:38 GMT -->
<head>
        <meta charset="utf-8" />
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14 d-inline-block text-truncate w-100">A line chart is a way of plotting data
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14 d-inline-block text-truncate w-100">A bar chart is a way of showing data as
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14 d-inline-block text-truncate w-100">Pie and doughnut charts are probably
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14 d-inline-block text-truncate w-100">Polar area charts are similar to pie
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14 d-inline-block text-truncate w-100">A radar chart is a way of showing
...
<!-- Mirrored from themesdesign.in/upcube/layouts/horizontal/charts-chartjs.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Mar 2018 13:17:39 GMT -->
</html>