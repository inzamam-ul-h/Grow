...
<!-- Mirrored from themesdesign.in/upcube/layouts/horizontal/charts-morris.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Mar 2018 13:17:35 GMT -->
<head>
        <meta charset="utf-8" />
    ...
    <body>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14 d-inline-block text-truncate w-100">Create bar charts using
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14 d-inline-block text-truncate w-100">The public API is terribly simple. It's
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14 d-inline-block text-truncate w-100">Create an area chart using
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14 d-inline-block text-truncate w-100">This really couldn't be easier. Create
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card card-primary m-b-30">
                            <div class="card-body">

                                <h4 class="mt-0 text-white header-title">Stacked Chart</h4>
                    ...
                    <div class="col-lg-4">
                        <div class="card card-info m-b-30">
                            <div class="card-body">

                                <h4 class="mt-0 text-white header-title">Donut Chart</h4>

                                <div id="morris-donut-example-dark" style="height: 300px"></div>
                    ...
                    <div class="col-lg-4">
                        <div class="card bg-dark m-b-30">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 text-white header-title">Line Chart</h4>

                                <div id="morris-line-example-dark" style="height: 300px"></div>
