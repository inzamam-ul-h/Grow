...
<!-- Mirrored from themesdesign.in/upcube/layouts/horizontal/charts-c3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Mar 2018 13:17:45 GMT -->
<head>
        <meta charset="utf-8" />
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14">Display as Bar Chart.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14">Display as Stacked Area Chart.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14">Display as roated Chart.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14">Display all kinda charts up in here.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14">Display as Donut Chart.</p>
...
<!-- Mirrored from themesdesign.in/upcube/layouts/horizontal/charts-c3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Mar 2018 13:17:50 GMT -->
</html>